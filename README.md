...
Among the 6 datasets, there are a total of 3240 records (in .WAV format), obtained from 764 patients, with a sampling frequency of 2000 Hz and a resolution of 16 bits. Additionally, annotations are available indicating whether the records exhibit any anomalies. These anomalies are related to previous conditions suffered by the patient and may include defects in heart valves or coronary artery diseases. It is worth noting that this database is freely available for download (see: https://physionet.org/content/challenge-2016/1.0.0/).
